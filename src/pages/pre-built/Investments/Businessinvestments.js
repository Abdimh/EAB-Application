...
const InvoiceList = () => {
  ...
  const onFormSubmits = async (submitData) => {
      ...
      <Content>
          ...
          <BlockBetween>
            ...
            <BlockHeadContent>
              <ul className="nk-block-tools g-3">
                {user.role.name === "Relation Officer  BI" && (
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">New Investment</h5>
              <div className="mt-4">
                ...
                <Form className="row gy-4" onSubmit={handleSubmit(onFormSubmit)}>
                  <Col md="6">
                    <FormGroup>
                      ...
                      />
                      {errors.applicantName && <span className="invalid">{errors.applicantName.message}</span>}
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <div className="form-control-wrap">
                        <select
                          name="typeofcompany"
                          className="form-control"
                          defaultValue={formData.typeValue}
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        defaultValue={formData.dateofestablishment}
                      ...
                      {errors.dateofestablishment && (
                        <span className="invalid">{errors.dateofestablishment.message}</span>
                      )}
                    </FormGroup>
                  </Col>
                  <Col md="6">
