...
import { ProductContextProvider } from "../pages/pre-built/Applications/ProductContext";
...
import ProjectCardPage from "../pages/pre-built/Customers/ProjectCard";
import CustomersList from "../pages/pre-built/Customers/CustomersList";
import UserList from "../pages/pre-built/user-manage/UsersList";
import UserRoles from "../pages/pre-built/user-manage/UserRoles";

import UserTitles from "../pages/pre-built/user-manage/UserTitles";
    ...
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/user-roles`}
          render={() => (
            <UserContextProvider>
              <UserRoles />
            </UserContextProvider>
        ...
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/user-titles`}
          render={() => (
            <UserContextProvider>
              <UserTitles />
            </UserContextProvider>
